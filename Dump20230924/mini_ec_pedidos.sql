...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_pedido_status` AFTER UPDATE ON `pedidos` FOR EACH ROW BEGIN
    INSERT INTO rastreabilidade (num_pedido, status_ped, data_hora, id_user)
    VALUES (NEW.num_pedido, NEW.status_ped, NOW(), 'nome_do_usuario');
END */;;
DELIMITER ;
